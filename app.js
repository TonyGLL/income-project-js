...
var UIController = (function () {  
    ...
    return {
        ...
        displayMonth: function () {  
            ...
            months = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'Septenber', 'October', 'November', 'December'];
...
var controller = (function (budgetCtrl, UICtrl) {
    ...
    var updatePercentages = function () {  
        ...
        // 3. Update the UI with the new percentajes
        UICtrl.displayPercentages(percentages);
    };

    var ctrlAddItem = function () {  

        var input, newItem, addList, clearF;
        ...
        if (input.description !== '' && !isNaN(input.value) && input.value > 0) {
            ...
            // 3. Add th new item to the UI
            addList = UICtrl.addListItem(newItem, input.type);
    
            // 4. Clear the fields
            clearF = UICtrl.clearFields();
